...
export default function App() {
  ...
  // Admin routes have their own navigation/header through AdminLayout.
  // Keep the marketplace Navbar completely separate so it never appears twice.
  const isAdminRoute = location === '/admin' || location.startsWith('/admin/');

  return <div className="market-shell">
    <div className="grain" />
    {!isAdminRoute && <Navbar theme={theme} onToggleTheme={() => setTheme(value => value === 'dark' ? 'light' : 'dark')} />}
    <main>
      <Switch>
