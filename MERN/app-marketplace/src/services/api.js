...
export const api = {
  ...
  payments: {
    createOrder: (orderId) => request('/payments/create-order', {
      method: 'POST',
      body: JSON.stringify({ orderId }),
    }),
    verify: (payload) => request('/payments/verify', {
      method: 'POST',
  ...
  contact: {
    submit: (payload) => request('/contact', {
      method: 'POST',
      body: JSON.stringify(payload),
    }),
  },
  ...
  admin: {
    ...
    cancelOrder: (id) => request(`/admin/orders/${id}/cancel`, { method: 'PUT' }),
  },
};
